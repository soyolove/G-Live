...
!(function (t, e) {
  ...
  class M {
    ...
    reserve(t, e, i) {
      if (i <= 0)
        return (
          l.log(this.tag, "Cannot start a motion with MotionPriority.NONE."), !1
        );
      if (t === this.currentGroup && e === this.currentIndex)
        return (
          l.log(this.tag, "Motion is already playing.", this.dump(t, e)), !1
        );
      if (
        ...
        return (
          l.log(this.tag, "Motion is already reserved.", this.dump(t, e)), !1
        );
      if (1 === i) {
  ...
  var P = ((t) => ((t.ALL = "ALL"), (t.IDLE = "IDLE"), (t.NONE = "NONE"), t))(
    P || {}
  );
  class C extends e.EventEmitter {
    ...
    startMotion(e, i) {
      return __async(this, arguments, function* (e, i, s = y.NORMAL) {
        ...
        let o;
        if (
          (this.currentAudio && v.dispose(this.currentAudio), t.config.sound)
        ) {
        ...
        if (o) {
          const e = v
            .play(o)
            .catch((t) => l.warn(this.tag, "Failed to play audio", o.src, t));
    ...
    stopAllMotions() {
      this._stopAllMotions(),
        this.state.reset(),
        this.currentAudio &&
          (v.dispose(this.currentAudio), (this.currentAudio = void 0));
    }
    update(t, e) {
      var i;
      return (
        this.isFinished() &&
          ...
          this.state.shouldRequestIdleMotion() &&
            this.startRandomMotion(this.groups.idle, y.IDLE)),
    ...
    static createXHR(t, e, i, s, r) {
      ...
      if ((w.allXhrSet.add(a), t)) {
        ...
        e ? e.add(a) : ((e = new Set([a])), w.xhrMap.set(t, e)),
          t.listeners("destroy").includes(w.cancelXHRs) ||
            t.once("destroy", w.cancelXHRs);
      }
      return (
        a.open("GET", e),
        (a.responseType = i),
    ...
    U = class {
      ...
      static loadMotion(t, e, i) {
        ...
        try {
          ...
          t.listeners("destroy").includes(U.releaseTasks) ||
            t.once("destroy", U.releaseTasks);
            ...
            null != n[i] ||
              (n[i] = E.load({
                ...
                .then((s) => {
                  var r;
                  const o =
                    null == (r = U.motionTasksMap.get(t)) ? void 0 : r[e];
                  o && delete o[i];
      ...
      static releaseTasks() {
        this instanceof C
          ? U.motionTasksMap.delete(this)
          : U.expressionTasksMap.delete(this);
      }
    };
  let N = U;
  (N.runtimes = []),
  ...
  class V {
    ...
    set autoInteract(t) {
      t !== this._autoInteract &&
        (t ? this.on("pointertap", G, this) : this.off("pointertap", G, this),
    ...
    registerInteraction(t) {
      t !== this.interactionManager &&
        ...
        this._autoInteract &&
          t &&
          ((this.interactionManager = t), t.on("pointermove", j, this)));
    }
    ...
    set autoUpdate(t) {
      ...
      Y || (Y = null == (e = window.PIXI) ? void 0 : e.Ticker),
        t
          ? this._destroyed ||
            (Y
              ? (Y.shared.add(this.onTickerUpdate, this),
                (this._autoUpdate = !0))
              : l.warn(
                  this.tag,
                  "No Ticker registered, please call Live2DModel.registerTicker(Ticker)."
                ))
          : (null == Y || Y.shared.remove(this.onTickerUpdate, this),
            (this._autoUpdate = !1));
    }
    init(t) {
    ...
    _render(t) {
      ...
      (this.internalModel.viewport = [i.x, i.y, i.width, i.height]),
        this.deltaTime &&
          ...
          (this.deltaTime = 0));
      const s = W.copyFrom(t.globalUniforms.uniforms.projectionMatrix).append(
        this.worldTransform
      );
  ...
  const Z = class {
    ...
    static createSettings(t) {
      return __async(this, null, function* () {
        const e = (yield Z.getFilePaths(t)).find(
  ...
  if (
    ...
    (J.factory = (t, e) =>
      __async(this, null, function* () {
        ...
        if (
          ("string" == typeof i &&
          (i.endsWith(".zip") || i.startsWith(Z.ZIP_PROTOCOL))
            ? ((s = i.startsWith(Z.ZIP_PROTOCOL)
                ? i.slice(Z.ZIP_PROTOCOL.length)
                : i),
              (r = yield E.load({
                url: s,
                type: "blob",
  ...
  class K extends AMotion {
    constructor(e) {
      super(),
        (this.params = []),
        this.setFadeIn(
          e.fade_in > 0 ? e.fade_in : t.config.expressionFadingDuration
        ),
        this.setFadeOut(
          e.fade_out > 0 ? e.fade_out : t.config.expressionFadingDuration
        ),
    ...
    init(t) {
      super.init(t),
        this.settings.expressions &&
          (this.expressionManager = new tt(this.settings, t));
    }
    isFinished() {
      return this.queueManager.isFinished();
    }
      ...
      const r = Live2DMotion.loadMotion(e),
        a =
          i === this.groups.idle
            ...
            : t.config.motionFadingDuration;
      return (
        r.setFadeIn(s.fade_in > 0 ? s.fade_in : a),
        ...
        case 1:
          this.setEyeParams(this.eyeParamValue + t / this.closingDuration),
            this.eyeParamValue <= 0 &&
              ((this.eyeState = 2), (this.closedTimer = 0));
          break;
        case 2:
          (this.closedTimer += t),
    ...
    static dispose() {
      yt
        ? Mt
          ? (pt.staticRelease(),
            (Mt = !1),
            It("CubismFramework.dispose() is complete."))
  ...
  class Yt {
    ...
    getEvaluationOptionFlag(t) {
      return (
        Ht.EvaluationOptionFlag_AreBeziersRistricted == t &&
    ...
    for (let l = s.baseSegmentIndex; l < a; ++l)
      if (
        ((o =
          ...
          (t.segments[l].segmentType == Vt.CubismMotionSegmentType_Bezier
            ? 3
            : 1)),
        t.points[o].time > i)
      ) {
  ...
  class ee extends Et {
    ...
    doUpdateParameters(t, e, i, s) {
      ...
      for (
        ...
        f[m].type == Nt.CubismMotionCurveTarget_Model;
        ++m
      )
        (g = te(this._motionData, m, _)),
          f[m].id == this._modelCurveIdEyeBlink
            ? (n = g)
            : f[m].id == this._modelCurveIdLipSync && (o = g);
      for (
        ;
        m < this._motionData.curveCount &&
        f[m].type == Nt.CubismMotionCurveTarget_Parameter;
        ++m
      ) {
        ...
        if (f[m].fadeInTime < 0 && f[m].fadeOutTime < 0) a = r + (g - r) * i;
          ...
          (t =
            f[m].fadeInTime < 0
              ...
              ? 1
              : gt.getEasingSine(
                  (e - s.getFadeInStartTime()) / f[m].fadeInTime
                )),
            (i =
              f[m].fadeOutTime < 0
                ? c
      ...
      for (
        ;
        m < this._motionData.curveCount &&
        f[m].type == Nt.CubismMotionCurveTarget_PartOpacity;
        ++m
      )
    ...
    parse(t) {
      ...
      const i = e.getEvaluationOptionFlag(
          Ht.EvaluationOptionFlag_AreBeziersRistricted
        ),
          ...
          switch (e.getMotionCurveSegment(n, l)) {
            case Vt.CubismMotionSegmentType_Linear:
              (this._motionData.segments[o].segmentType =
                Vt.CubismMotionSegmentType_Linear),
            ...
            case Vt.CubismMotionSegmentType_Bezier:
              (this._motionData.segments[o].segmentType =
                Vt.CubismMotionSegmentType_Bezier),
            ...
            case Vt.CubismMotionSegmentType_Stepped:
              (this._motionData.segments[o].segmentType =
                Vt.CubismMotionSegmentType_Stepped),
            ...
            case Vt.CubismMotionSegmentType_InverseStepped:
              (this._motionData.segments[o].segmentType =
                Vt.CubismMotionSegmentType_InverseStepped),
  ...
  class ie extends C {
    ...
    init(t) {
      super.init(t),
        this.settings.expressions &&
          (this.expressionManager = new Ot(this.settings, t)),
    ...
    init() {
      ...
      super.init(),
        (null == (t = this.settings.getEyeBlinkParameters())
          ? void 0
          : t.length) > 0 && (this.eyeBlink = oe.create(this.settings)),
  ...
  function Ee(t) {
    (t = Object.assign(
      { logFunction: console.log, loggingLevel: St.LogLevel_Verbose },
      t
    )),
      Ct.startUp(t),
      Ct.initialize();
  ...
  function ii(t, e, i, s, r, a, o, n) {
    ...
    for (let _ = 1; _ < e; ++_)
      (t[_].force = u.multiplyByScaler(t[_].acceleration).add(r)),
        ...
        p.normalize(),
        (t[_].position = t[_ - 1].position.add(
          p.multiplyByScaler(t[_].radius)
        )),
  ...
  N.registerRuntime({
    ...
    createInternalModel(t, e, i) {
      const s = new Ie(t, e, i),
        r = t;
      return (
        r.__moc && ((s.__moc = r.__moc), delete r.__moc, s.once("destroy", ai)),
        s
      );
    },
